  ...
  return (
    <div className="relative">
      <input type="text" value={value} onChange={e => setValue(e.target.value)} placeholder={placeholder}
        className="w-full px-4 py-3 bg-white text-gray-900 placeholder-gray-500 border border-gray-200 rounded-lg shadow-sm focus:ring-2 focus:ring-brand-500 focus:border-brand-500 outline-none" />
